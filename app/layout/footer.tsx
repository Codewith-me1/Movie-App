...
export const Footer = () => {
  return (
    <footer
      style={{
        backgroundImage: "url('/images/popcornbg.png')",
        backgroundRepeat: "no-repeat", // Prevents repeating
        backgroundPosition: "bottom",
        backgroundSize: "contain", // Ensures it covers the entire container
      }}
      className=" glossy-effect mt !border-t-2 !border-y-0 !border-x-0 pb-40 mt-40 relative"
    >
      <div className="absolute inset-x-0 -top-[7rem] flex justify-center">
        {/* Image in the middle of the border */}
        <img
          src="/images/popcorn3.png"
          alt="Decorative"
          className="w-[12rem] h-[12rem] object-contain"
        />
      </div>
      <div className="max-w-screen-xl px-4 pt-16   mx-auto pb-40 sm:px-6 lg:px-8 lg:pt-24">
