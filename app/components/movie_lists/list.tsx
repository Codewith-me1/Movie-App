      ...
      try {
        const response = await fetch(url, {
          ...
          headers: {
            ...
            Authorization: `Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjOTVkN2EyMzkyMTA0YWMwNTNlNTYxN2IxYWRiY2I4MiIsIm5iZiI6MTcyODc4NjQxOC41NjU3MTEsInN1YiI6IjY3MDkzNDFhZWU5NjE0ODU4NzI0ZGU4ZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.5xkp6P9Zhrx9HuCjhcI5YBvNFQiSUiiIX3p7Fm71W6c`,
          },
        });
